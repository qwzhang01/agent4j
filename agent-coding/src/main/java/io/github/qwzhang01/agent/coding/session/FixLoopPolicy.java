...
/**
 * The fix-loop budget (, blueprint D4: "the boundary lives in the engine,
 ...
 * <p>
 * Why not just reuse {@code maxSteps} : maxSteps counts every ReAct step - it
 * cannot tell "converging healthily" (read 5 files, , test once) from "bleeding
