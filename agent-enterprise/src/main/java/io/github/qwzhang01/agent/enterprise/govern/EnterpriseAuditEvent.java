...
/**
 * An audit fact with enterprise attribution (, D4
 * "compose, don't modify".
 * <p>
 * {@link AuditEvent} is the generic governance fact (runId + toolName
 ...
 * enterprise-layer concept. Rather than changing the immutable record
 * (and every existing consumer), the enterprise layer wraps it:
 * composition over modification, the same discipline as the /12/14
 * decorators.
 * <p>
 ...
 * assembled agent name; the service-identity side is wired when the
