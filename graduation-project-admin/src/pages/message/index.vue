    ...
    <t-form ref="form" :data="formData" :label-width="80" colon @reset="onReset" @submit="onSubmit"
      ...
      <t-row>
          ...
          <t-row :gutter="[16, 24]">
            <t-col :flex="1" :span="4">
              <t-form-item label="用户" name="name">
                <t-input v-model="formData.name" class="form-item-content" type="search" placeholder="请输入消息标题"
        ...
        <t-col :span="2" class="operation-container">
          <router-link to="/msg/form">
            <t-button type="reset" variant="base" theme="primary"> 新增 </t-button>
          </router-link>
