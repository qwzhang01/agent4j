    ...
    <t-form ref="form" :data="formData" :label-width="80" colon @reset="onReset" @submit="onSubmit"
      ...
      <t-row>
        <t-col :span="10">
          <t-row :gutter="[16, 24]">
            <t-col :flex="1" :span="4">
              <t-form-item label="字典" name="name">
                <t-input v-model="formData.name" class="form-item-content" type="search" placeholder="请输入字典"
...
export default {
  ...
  data() {
    return {
      ...
      value: 'first',
      columns: [
        { title: '字典类型', colKey: 'type' },
        { title: '字典键', colKey: 'key' },
        { title: '字典值', colKey: 'value' },
      ],
      rowKey: 'index',
      verticalAlign: 'top',
      hover: true,
