...
public class NativeCacheConfig {
     ...
     * 本地缓存管理器
     */
    public static class NativeCacheManager extends AbstractCacheManager {

        /**
         * 缓存队列
         */
        private final Collection<org.springframework.cache.Cache> caches = new CopyOnWriteArraySet<>();
         ...
         * @return
         */
        public NativeCacheManager putCache(org.springframework.cache.Cache cache) {
